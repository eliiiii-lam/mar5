...
public class BlueScanLong extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory traj1BLL = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-30,1.75,Math.toRadians(90)))
                .build();
        ...
        Trajectory traj3BLL = drive.trajectoryBuilder(traj2BLL.end())
                .lineToLinearHeading(new Pose2d(-52,-60,Math.toRadians(270)))
                .build();
        Trajectory traj4BLL = drive.trajectoryBuilder(traj3BLL.end())
                .lineToLinearHeading(new Pose2d(-21,-83,Math.toRadians(270)))
                .build();
        ...
        Trajectory traj3BCL = drive.trajectoryBuilder(traj2BCL.end())
                .lineToLinearHeading(new Pose2d(-26,-83,Math.toRadians(270)))
                .build();
        ...
        Trajectory traj1BRL = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-44,7,Math.toRadians(200)))
                .build();
        ...
        Trajectory traj4BRL = drive.trajectoryBuilder(traj3BRL.end())
                .lineToLinearHeading(new Pose2d(-36,-83,Math.toRadians(270)))
                .build();

        Trajectory traj5RLL = drive.trajectoryBuilder(traj4BRL.end())
                .strafeLeft(32)
                .build();
